...
function Jobsy() {
  ...
  return (
    <Layout>
      <div className='flex flex-col-reverse lg:flex-row justify-center items-center lg:mt-[150px] lg:gap-[5rem]'>

        {/* LEFTE SEITE */}
        <section className='w-[full] lg:w-[40%] mt-8 lg:h-[500px] flex flex-col justify-center items-center lg:items-end'>
          <div
            aria-label='Jobsy Logo'
            className='flex justify-center items-center gap-1 mb-3 lg:mb-[3rem] '>
          ...
          <p className='text-beige leading-[1.2rem] w-[80%] text-[0.80ms] text-center lg:w-[200px] text-opacity-90'>is a modern, user-friendly <span onClick={JobsyClick} className='font-bold underline cursor-pointer'>job portal</span> that connects job seekers with potential employers. The website is built with the latest technologies, including MERN Stack and is designed to be accessible to all. Whether you're looking for a new job or looking to hire, Jobsy makes the process simple and straightforward.</p>
        </section>

        {/* RECHTE SEITE */}
        <section className='w-[full] mx-8 lg:w-[60%] flex flex-col justify-center items-start'>
